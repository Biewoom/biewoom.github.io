...
수학문제 풀 때는 수학 공식이 있었다면, PS는 알고리즘이 있다고 생각하면 된다.<br/>
...
아래의 'How to solve it'은 한 번쯤 꼭 읽어봤으면 한다. PS의 패러다임을 제시한다.<br/>
...
# 어떻게 PS를 학습해야 할까?
학습법은 기본적으로는 [학습 매커니즘](../spy/)을 바탕에 두고 이루어진다.<br/>
아래 학습법을 정확히 이해 하려면, 위의 매커니즘 포스팅을 읽고 와야 한다.<br/>

1. 시도하기:<br/>
  먼저, 아무 배경 지식 없이 혼자 힘으로 풀어보기(최대한 노력하기)<br/>
  ※ 최대한 노력하기는 나의 기준에선 정량적으론 3시간 이상 고민하는 것이다.

2. 자신이 지금 학습곡선의 어느 지점인지 진단하기:<br/>
자신이 너무 부족해 문제 자체를 못 건들정도 경우 -> 모방학습<br/>
대부분의 개념은 풀었지만 한 두개의 개념에서 막힌다 -> 발견학습<br/>

3. 인지적 도제학습:<br/>
  Github에서의 코드 또는 블로그들의 코드를 의식적인 copy-coding 하기.
