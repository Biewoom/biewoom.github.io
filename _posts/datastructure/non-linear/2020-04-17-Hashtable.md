...
더 나아가, '재석' 뿐 아니라 다른 학생들 모두 수학 점수가 궁금해서 찾아오면 어떡할까요?<br/>
**매 학생이 물을 때마다, 모든 데이터를 한번씩 체크해야 하는 건 굉장히 비효율적입니다.**<br/>
...
하지만 index가 1인 slot에는 아무런 데이터가 저장되어있지 않습니다.<br/>

> 실제론, Birthday-paradox 같은 문제로 Collision이 생길 수 밖에 없습니다.<br/>
> 이를 해결하기 위한 전략으로는 Openaddress나 chaning 등 몇 가지가 있습니다.<br/>
...
이 경우 이전 방법보다 시간효율성이 좋다고는 하기 어려울거 같습니다.<br/>
...
# HashTable과 관련된 용어:
구현 언어에 따라 또는 구현 방법에 따라 또는 나중에 이야기할 전략에 따라<br/>
HashTable 관련 용어들은 조금씩 다릅니다. 그 중에는  HashMap, Map, Dictionary 있습니다.<br/>
